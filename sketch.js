...
function setup() {
  ...
  ground = createSprite(camera.x-50,height-40,400,20);
  ...
  invisibleGround = createSprite(camera.x,height-30,width,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(camera.x+width/2,height-45,20,30);
    //obstacle.debug = true;
